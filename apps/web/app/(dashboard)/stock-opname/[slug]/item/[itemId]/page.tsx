...
export default function StockOpnameAdminDetailItemPage() {
  ...
  const apiItem = useMemo(() => {
    ...
    return (
      (session.items as ApiStockOpnameItem[]).find(
  ...
  const conditionDisplay =
    conditionAfter ??
    conditionBefore ??
    (si as { condition?: string })?.condition ??
    "—"
        ...
        <Card>
          <CardContent className="py-10 text-center">
            ...
            <Button
              variant="outline"
              className="mt-4"
              onClick={() => router.push(`/stock-opname/${slug}`)}
            >
      ...
      <div className="flex flex-col gap-2">
        ...
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbItem>
              <BreadcrumbLink href={`/stock-opname/${slug}`}>
                Detail Batch
              </BreadcrumbLink>
            </BreadcrumbItem>
            <BreadcrumbSeparator>
            ...
            <div className="grid grid-cols-1 gap-8 lg:grid-cols-[250px_1fr]">
              ...
              <div className="flex justify-center">
                <Avatar className="size-48">
                  <AvatarImage src={allEvidenceUrls[0]} alt={itemTitle} />
