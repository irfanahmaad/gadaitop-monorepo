...
By default, your server will run at [localhost:8080](http://localhost:8080). You can use your favorite API platform like [Insomnia](https://insomnia.rest/) or [Postman](https://www.postman.com/) to test your APIs
